...
#define  configMINIMAL_STACK_SIZE        ( ( unsigned short ) /* was 256 */ 512 /* <--NDV */ )
#define  configISR_STACK_SIZE_WORDS      /* was 128 */ 256 /* <--NDV */
#define  configTOTAL_HEAP_SIZE           ( ( size_t ) /* was 5 */ 12 /* <--NDV */ * 1024 )
